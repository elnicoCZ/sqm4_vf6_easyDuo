...
#define ACCEL_MMA845xQ_CHANNEL_NO           I2C0_NO
#define ACCEL_MMA845xQ_DRIVER_MODE          I2C0_DRIVER_MODE
#define ACCEL_MMA845xQ_CHANNEL_MODE         I2C0_CHANNEL_MODE
#define ACCEL_MMA845xQ_CHANNEL_BAUDRATE     I2C0_BAUDRATE
#define ACCEL_MMA845xQ_SA0                  (0)
#define ACCEL_MMA845xQ_DEVICE_ADDRESS       ESL_I2C_MMA845XQ_SLAVE_ADDRESS(ACCEL_MMA845xQ_SA0)
#define ACCEL_MMA845xQ_REG_ADDR_SIZE        ESL_I2C_MMA845XQ_REG_ADDR_SIZE
